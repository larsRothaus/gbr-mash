...
import { Fetcher } from '@plasmicapp/react-web/lib/data-sources'; // plasmic-import: rQlQNPwxvhL5/codeComponent
...
import sty from './PlasmicHomepage.module.css'; // plasmic-import: NPd_In1Oo0LG/css
...
const PlasmicDescendants = {
  root: ['root', 'pageLayout', 'section', 'h1', 'text', 'dataList'],
  pageLayout: ['pageLayout', 'section', 'h1', 'text', 'dataList'],
