...
import IconIcon from './icons/PlasmicIcon__Icon'; // plasmic-import: oD8p6UEfEUXs/icon
import Icon2Icon from './icons/PlasmicIcon__Icon2'; // plasmic-import: nec779uSF8vO/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__oaIps)}
          role={'img'}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {($ctx) => (
              <div className={classNames(projectcss.all, sty.freeBox__eql)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__smbkk)}
                  role={'img'}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {($ctx) => (
            <div className={classNames(projectcss.all, sty.freeBox__ashe)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__trWbL)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
